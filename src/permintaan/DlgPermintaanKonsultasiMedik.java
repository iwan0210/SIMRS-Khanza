            ...
            try {
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        template += "TB: " + rs.getString("tb").trim() + " cm\n";
                        template += "BB: " + rs.getString("bb").trim() + " kG\n";
                        template += "TD: " + rs.getString("td").trim() + " mmHg\n";
                        template += "Nadi: " + rs.getString("nadi").trim() + " x/menit\n";
                        template += "RR: " + rs.getString("rr").trim() + " x/menit\n";
                        template += "Suhu: " + rs.getString("suhu").trim() + " \u00B0C\n";
