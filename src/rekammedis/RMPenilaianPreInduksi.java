...
public final class RMPenilaianPreInduksi extends javax.swing.JDialog {
    ...
    public RMPenilaianPreInduksi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{
            "No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", // 0-4
            "Kode Dokter", "Nama Dokter", "Tanggal", // 5-7
            "TD(mmHg)", "Nadi(x/menit)", "RR(x/menit)", "Suhu(°C)", "EKG", "Lain-lain", // 8-13
            "Asesmen", "Perencanaan", "Infus Perifier, Tempat & Ukuran", "CVC", "Posisi", // 14-18
            "Premedikasi", "Keterangan Premedikasi", "Induksi", "Keterangan Induksi", // 19-22
            "Face Mask No", "Oro/Nasopharing No", "ETT No", "ETT Jenis", "ETT Fiksasi", // 23-27
            "LMA No", "LMA Jenis", "Tracheostomi", "Bronchoscopi Fiberoptik", "Glidescopi", // 28-32
            "Tatalaksana Lain-lain", "Intubasi Sesudah Tidur", "Intubasi Oral", // 33-35
            "Intubasi Tracheostomi", "Keterangan Intubasi", "Sulit Ventilasi", // 36-38
            "Sulit Intubasi", "Ventilasi", "T.R.Jenis", "T.R.Lokasi", // 39-42
            "T.R.Jenis Jarum/No", "T.R.Kateter", "T.R.Kateter Fiksasi", // 43-45
            "T.R.Obat Obatan", "T.R.Komplikasi", "T.R.Hasil", // 46-48
            "klasifikasi ASA", "Pasca Anestesi", "Keadaan Umum", "Monitoring" // 49-52
        }) {
            @Override
        ...
        for (i = 0; i < 53; i++) {  // ✅ BENAR: untuk 53 kolom (indeks 0-52)
            ...
            if (i == 0) {
                ...
                column.setPreferredWidth(150);
                // TAMBAHAN: Width untuk kolom 49-52
            } else if (i == 49) {
                column.setPreferredWidth(100); // klasifikasi ASA
            } else if (i == 50) {
                column.setPreferredWidth(100); // Pasca Anestesi
            } else if (i == 51) {
                column.setPreferredWidth(100); // Keadaan Umum
            } else if (i == 52) {
                column.setPreferredWidth(100); // Monitoring
            }
        }
    ...
    private void initComponents() {
        ...
        pscanestesi = new widget.ComboBox();
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(750, 1250));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-07-2025 08:20:32" }));
        ...
        IntubasiSulitIntubasi.setBounds(150, 820, 574, 23);
        ...
        Ventilasi.setBounds(100, 850, 626, 23);
        ...
        klasifikasiASA.setBounds(160, 590, 100, 23);
        ...
        jLabel144.setBounds(20, 590, 131, 23);
        ...
        KeadaanUmum.setBounds(139, 560, 580, 23);

        jLabel40.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel40.setText("Klasifikasi ASA");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(70, 590, 80, 23);

        jLabel145.setText(":");
        jLabel145.setName("jLabel145"); // NOI18N
        FormInput.add(jLabel145);
        jLabel145.setBounds(0, 620, 124, 20);
        ...
        IntubasiOral.setBounds(380, 710, 85, 23);

        jLabel150.setText("Tracheostomi :");
        jLabel150.setName("jLabel150"); // NOI18N
        FormInput.add(jLabel150);
        jLabel150.setBounds(550, 710, 90, 23);
        ...
        IntubasiTracheostomi.setBounds(640, 710, 85, 23);
        ...
        scrollPane3.setBounds(140, 740, 582, 43);

        jLabel152.setText(":");
        jLabel152.setName("jLabel152"); // NOI18N
        FormInput.add(jLabel152);
        jLabel152.setBounds(0, 740, 138, 23);

        jLabel151.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel151.setText("Keterangan");
        jLabel151.setName("jLabel151"); // NOI18N
        FormInput.add(jLabel151);
        jLabel151.setBounds(70, 740, 90, 23);

        jLabel153.setText(":");
        jLabel153.setName("jLabel153"); // NOI18N
        FormInput.add(jLabel153);
        jLabel153.setBounds(0, 790, 149, 23);
        ...
        jLabel157.setBounds(40, 880, 190, 23);

        jLabel158.setText(":");
        jLabel158.setName("jLabel158"); // NOI18N
        FormInput.add(jLabel158);
        jLabel158.setBounds(0, 900, 107, 23);
        ...
        TeknikRegionalJenis.setBounds(110, 900, 613, 23);

        jLabel44.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel44.setText("Jenis");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(70, 900, 90, 23);

        jLabel159.setText(":");
        jLabel159.setName("jLabel159"); // NOI18N
        FormInput.add(jLabel159);
        jLabel159.setBounds(0, 930, 111, 23);
        ...
        TeknikRegionalLokasi.setBounds(120, 930, 310, 23);

        jLabel45.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel45.setText("Lokasi");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(70, 930, 90, 23);
        ...
        TeknikRegionalJenisJarum.setBounds(550, 930, 170, 23);

        jLabel46.setText("Jenis Jarum / No :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(450, 930, 100, 23);

        jLabel162.setText(":");
        jLabel162.setName("jLabel162"); // NOI18N
        FormInput.add(jLabel162);
        jLabel162.setBounds(0, 960, 118, 23);

        pscanestesi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Rawat Jalan", "Rawat Inap", "HCU" }));
        pscanestesi.setName("pscanestesi"); // NOI18N
        pscanestesi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                pscanestesiKeyPressed(evt);
            }
        });
        FormInput.add(pscanestesi);
        pscanestesi.setBounds(600, 590, 100, 23);

        jLabel161.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel161.setText("Keteter");
        jLabel161.setName("jLabel161"); // NOI18N
        FormInput.add(jLabel161);
        jLabel161.setBounds(70, 960, 90, 23);

        jLabel160.setText("Kateter Fiksasi :");
        jLabel160.setName("jLabel160"); // NOI18N
        FormInput.add(jLabel160);
        jLabel160.setBounds(210, 960, 116, 23);
        ...
        TeknikRegionalKateterFiksasi.setBounds(330, 960, 140, 23);

        jLabel47.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel47.setText("cm");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(470, 960, 30, 23);

        jLabel164.setText(":");
        jLabel164.setName("jLabel164"); // NOI18N
        FormInput.add(jLabel164);
        jLabel164.setBounds(450, 590, 143, 23);
        ...
        scrollPane4.setBounds(150, 990, 577, 43);

        jLabel163.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel163.setText("Perawatan pasca Anestesi");
        jLabel163.setName("jLabel163"); // NOI18N
        FormInput.add(jLabel163);
        jLabel163.setBounds(450, 590, 140, 23);

        jLabel166.setText(":");
        jLabel166.setName("jLabel166"); // NOI18N
        FormInput.add(jLabel166);
        jLabel166.setBounds(0, 1040, 133, 23);
        ...
        TeknikRegionalHasil.setBounds(110, 1090, 615, 23);

        jLabel48.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel48.setText("Hasil");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(70, 1090, 90, 23);

        jLabel168.setText(":");
        jLabel168.setName("jLabel168"); // NOI18N
        FormInput.add(jLabel168);
        jLabel168.setBounds(0, 560, 131, 23);

        jLabel49.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel49.setText("Keadaan Umum");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(40, 560, 80, 23);

        jLabel50.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel50.setText("Glidescopi");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(74, 530, 80, 23);
        ...
        TeknikRegionalKateter.setBounds(120, 960, 85, 23);

        jLabel172.setText(":");
        jLabel172.setName("jLabel172"); // NOI18N
        FormInput.add(jLabel172);
        jLabel172.setBounds(0, 530, 131, 23);

        jLabel51.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel51.setText("Glidescopi");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(74, 530, 80, 23);
...
<<<<<<< HEAD
        ...
        if (TNoRM.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("penilaian_pre_induksi", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat, Tanggal & Jam", 48, new String[]{
                ...
                TeknikRegionalObatobatan.getText(), TeknikRegionalKomplikasi.getText(), TeknikRegionalHasil.getText(), klasifikasiASA.getSelectedItem().toString(), pscanestesi.getSelectedItem().toString(), KeadaanUmum.getText(),
                monitoring
            }) == true) {
                tabMode.addRow(new String[]{
                    ...
                    TeknikRegionalHasil.getText(), klasifikasiASA.getSelectedItem().toString(), pscanestesi.getSelectedItem().toString(), KeadaanUmum.getText(), monitoring
                });
                emptTeks();
...
>>>>>>> 5ea75f6b9cc63ff8343d7b0562476c8b8b7f8dae
    ...
    private void TeknikRegionalKateterFiksasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TeknikRegionalKateterFiksasiKeyPressed
        Valid.pindah(evt, pscanestesi, TeknikRegionalObatobatan);
    }//GEN-LAST:event_TeknikRegionalKateterFiksasiKeyPressed

    private void pscanestesiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pscanestesiKeyPressed
        Valid.pindah(evt, TeknikRegionalJenisJarum, TeknikRegionalKateterFiksasi);
    }//GEN-LAST:event_pscanestesiKeyPressed
    ...
    private void TeknikRegionalJenisJarumKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TeknikRegionalJenisJarumKeyPressed
        Valid.pindah(evt, TeknikRegionalLokasi, pscanestesi);
    ...
    private void TatalaksanaLainlainKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TatalaksanaLainlainKeyPressed
        Valid.pindah(evt, KeadaanUmum, IntubasiSesudahTidur);
    ...
    private void BronchoscopiFiberoptikKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BronchoscopiFiberoptikKeyPressed
        Valid.pindah(evt, Tracheostomi, KeadaanUmum);
    ...
    private void KeteranganInfusInduksiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KeteranganInfusInduksiKeyPressed
        Valid.pindah(evt, klasifikasiASA, FaceMaskNo);
    ...
    private widget.ComboBox pscanestesi;
        ...
        try {
            if (TCari.getText().trim().equals("")) {
                ps = koneksi.prepareStatement(
                        ...
                        + "if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_pre_induksi.tanggal,"
                        + "penilaian_pre_induksi.kd_dokter,dokter.nm_dokter,penilaian_pre_induksi.tensi,penilaian_pre_induksi.nadi,"
                        + "penilaian_pre_induksi.rr,penilaian_pre_induksi.suhu,penilaian_pre_induksi.ekg,penilaian_pre_induksi.lain_lain,"
                        + "penilaian_pre_induksi.asesmen,penilaian_pre_induksi.perencanaan,penilaian_pre_induksi.infus_perifier,"
                        + "penilaian_pre_induksi.cvc,penilaian_pre_induksi.posisi,penilaian_pre_induksi.premedikasi,"
                        + "penilaian_pre_induksi.premedikasi_keterangan,penilaian_pre_induksi.induksi,penilaian_pre_induksi.induksi_keterangan,"
                        + "penilaian_pre_induksi.face_mask_no,penilaian_pre_induksi.nasopharing_no,penilaian_pre_induksi.ett_no,"
                        + "penilaian_pre_induksi.ett_jenis,penilaian_pre_induksi.ett_viksasi,penilaian_pre_induksi.lma_no,"
                        + "penilaian_pre_induksi.lma_jenis,penilaian_pre_induksi.tracheostomi,penilaian_pre_induksi.bronchoscopi_fiberoptik,"
                        + "penilaian_pre_induksi.glidescopi,penilaian_pre_induksi.lain_lain_tatalaksana,"
                        + "penilaian_pre_induksi.intubasi_sesudah_tidur,penilaian_pre_induksi.intubasi_oral,"
                        + "penilaian_pre_induksi.intubasi_tracheostomi,penilaian_pre_induksi.intubasi_keterangan,"
                        + "penilaian_pre_induksi.sulit_ventilasi,penilaian_pre_induksi.sulit_intubasi,penilaian_pre_induksi.ventilasi,"
                        + "penilaian_pre_induksi.teknik_regional_jenis,penilaian_pre_induksi.teknik_regional_lokasi,"
                        + "penilaian_pre_induksi.teknik_regional_jenis_jarum,penilaian_pre_induksi.teknik_regional_kateter,"
                        + "penilaian_pre_induksi.teknik_regional_kateter_viksasi,penilaian_pre_induksi.teknik_regional_obat_obatan,"
                        + "penilaian_pre_induksi.teknik_regional_komplikasi,penilaian_pre_induksi.teknik_regional_hasil,"
                        + "penilaian_pre_induksi.klasifikasi_asa,penilaian_pre_induksi.pscanestesi,penilaian_pre_induksi.keadaan_umum,penilaian_pre_induksi.monitoring "
                        + "from reg_periksa "
                        + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                        + "inner join penilaian_pre_induksi on reg_periksa.no_rawat=penilaian_pre_induksi.no_rawat "
                        + "inner join dokter on penilaian_pre_induksi.kd_dokter=dokter.kd_dokter "
                        + "where penilaian_pre_induksi.tanggal between ? and ? "
                        + "order by penilaian_pre_induksi.tanggal");

            } else {
                ps = koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_pre_induksi.tanggal,"
                        + "penilaian_pre_induksi.kd_dokter,dokter.nm_dokter,penilaian_pre_induksi.tensi,penilaian_pre_induksi.nadi,penilaian_pre_induksi.rr,penilaian_pre_induksi.suhu,penilaian_pre_induksi.ekg,"
                        + "penilaian_pre_induksi.lain_lain,penilaian_pre_induksi.asesmen,penilaian_pre_induksi.perencanaan,penilaian_pre_induksi.infus_perifier,penilaian_pre_induksi.cvc,"
                        + "penilaian_pre_induksi.posisi,penilaian_pre_induksi.premedikasi,penilaian_pre_induksi.premedikasi_keterangan,penilaian_pre_induksi.induksi,penilaian_pre_induksi.induksi_keterangan,"
                        + "penilaian_pre_induksi.face_mask_no,penilaian_pre_induksi.nasopharing_no,penilaian_pre_induksi.ett_no,penilaian_pre_induksi.ett_jenis,penilaian_pre_induksi.ett_viksasi,"
                        + "penilaian_pre_induksi.lma_no,penilaian_pre_induksi.lma_jenis,penilaian_pre_induksi.tracheostomi,penilaian_pre_induksi.bronchoscopi_fiberoptik,penilaian_pre_induksi.glidescopi,"
                        ...
                        + "penilaian_pre_induksi.teknik_regional_lokasi,penilaian_pre_induksi.teknik_regional_jenis_jarum,penilaian_pre_induksi.teknik_regional_kateter,penilaian_pre_induksi.teknik_regional_kateter_viksasi,"
                        + "penilaian_pre_induksi.teknik_regional_obat_obatan,penilaian_pre_induksi.teknik_regional_komplikasi,penilaian_pre_induksi.teknik_regional_hasil,penilaian_pre_induksi.klasifikasi_asa,\n"
                        + "penilaian_pre_induksi.pscanestesi,penilaian_pre_induksi.keadaan_umum,penilaian_pre_induksi.monitoring \n"
                        + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                        + "inner join penilaian_pre_induksi on reg_periksa.no_rawat=penilaian_pre_induksi.no_rawat "
...
>>>>>>> 5ea75f6b9cc63ff8343d7b0562476c8b8b7f8dae
    ...
    public void emptTeks() {
        ...
        pscanestesi.setSelectedIndex(0);
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            klasifikasiASA.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 49).toString());
            pscanestesi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 50).toString());
            KeadaanUmum.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 51).toString());
            String MonitoringValue = tbObat.getValueAt(tbObat.getSelectedRow(), 52).toString();
            tampilkanMonitoring(MonitoringValue);
    ...
    private String getMonitoringValue() {
        ...
        if(Sequel.mengedittf("penilaian_pre_induksi","no_rawat=? and tanggal=?","no_rawat=?,tanggal=?,kd_dokter=?,tensi=?,nadi=?,rr=?,suhu=?,ekg=?,lain_lain=?,asesmen=?,perencanaan=?,"+
                ...
                "teknik_regional_obat_obatan=?,teknik_regional_komplikasi=?,teknik_regional_hasil=?,klasifikasi_asa=?,pscanestesi=?,keadaan_umum=?,monitoring=?",50,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                TD.getText(),Nadi.getText(),RR.getText(),Suhu.getText(),EKG.getText(),Lainlain.getText(),Asesmen.getSelectedItem().toString(),Perencanaan.getText(),
                InfusPerifier.getText(),CVC.getText(),PosisiInfus.getSelectedItem().toString(),Premedikasi.getSelectedItem().toString(),KeteranganPremedikasi.getText(),
                InfusInduksi.getSelectedItem().toString(),KeteranganInfusInduksi.getText(),FaceMaskNo.getText(),NasopharingNo.getText(),ETTNo.getText(),ETTJenis.getText(),
                ...
                TeknikRegionalLokasi.getText(),TeknikRegionalJenisJarum.getText(),TeknikRegionalKateter.getSelectedItem().toString(),TeknikRegionalKateterFiksasi.getText(),
                TeknikRegionalObatobatan.getText(),TeknikRegionalKomplikasi.getText(),TeknikRegionalHasil.getText(),klasifikasiASA.getSelectedItem().toString(),pscanestesi.getSelectedItem().toString(),KeadaanUmum.getText(),
                monitoring,tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(),
                ...
                tbObat.setValueAt(klasifikasiASA.getSelectedItem().toString(),tbObat.getSelectedRow(),49);
                tbObat.setValueAt(pscanestesi.getSelectedItem().toString(),tbObat.getSelectedRow(),50);
                tbObat.setValueAt(KeadaanUmum.getText(),tbObat.getSelectedRow(),51);
                tbObat.setValueAt(monitoring,tbObat.getSelectedRow(),52);
                emptTeks();
                TabRawat.setSelectedIndex(1);
