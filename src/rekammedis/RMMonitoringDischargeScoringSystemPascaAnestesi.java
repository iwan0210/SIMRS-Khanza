 ...
 * @author perpustakaan
 */
public final class RMMonitoringDischargeScoringSystemPascaAnestesi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMMonitoringDischargeScoringSystemPascaAnestesi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Post Anesthesia Discharge Scoring System (PADSS) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel217.setText("1. Tanda-tanda vital");
        ...
        SkalaKriteria1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "TD & N dalam >40% nilai pre-operasi", "TD & N dalam 20-40& nilai pre-operasi", "TD & N dalam 20% nilai pre-operasi" }));
        ...
        jLabel220.setText("2. Tingkat aktivitas");
        ...
        SkalaKriteria2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak mampu berjalan", "Perlu bantuan", "Berjalan stabil, tidak lemas" }));
        ...
        jLabel223.setText("3. Nyeri, Mual, dan Muntah");
        ...
        SkalaKriteria3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Berat", "Sedang", "Minimal" }));
        ...
        jLabel226.setText("4. Pendarahan Bedah");
        ...
        SkalaKriteria4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Berat : diperlukan >3x ganti balut", "Sedang : diperlukan ganti balut 2x", "Minimal : tidak perlu ganti balut" }));
        ...
        jLabel229.setText("5. Intake dan Output");
        ...
        SkalaKriteria5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak keduanya", "Minum atau BAK", "Minum dan BAK" }));
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptSkorMonitoringAldrette.jasper","report","::[ Data Skor Monitoring Aldrette Pasca Anestesi ]::",
                    ...
                    "inner join petugas on post_anesthesia_discharge_scoring_system.nip=petugas.nip where "+
                    "post_anesthesia_discharge_scoring_system.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' "+
                    "order by post_anesthesia_discharge_scoring_system.tanggal",param);
            }else{
                Valid.MyReportqry("rptSkorMonitoringAldrette.jasper","report","::[ Data Skor Monitoring Aldrette Pasca Anestesi ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,post_anesthesia_discharge_scoring_system.tanggal,"+
                    "post_anesthesia_discharge_scoring_system.penilaian_skala1,post_anesthesia_discharge_scoring_system.penilaian_nilai1,"+
                    ...
                    "inner join dokter on post_anesthesia_discharge_scoring_system.kd_dokter=dokter.kd_dokter "+
                    "inner join petugas on post_anesthesia_discharge_scoring_system.nip=petugas.nip where "+
                    "post_anesthesia_discharge_scoring_system.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' and "+
                    ...
                    "or post_anesthesia_discharge_scoring_system.kd_dokter like '%"+TCari.getText().trim()+"%' or dokter.nm_dokter like '%"+TCari.getText().trim()+"%' or post_anesthesia_discharge_scoring_system.nip like '%"+TCari.getText().trim()+"%' or petugas.nama like '%"+TCari.getText().trim()+"%') "+
                    "order by post_anesthesia_discharge_scoring_system.tanggal ",param);
            }  
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMMonitoringDischargeScoringSystemPascaAnestesi dialog = new RMMonitoringDischargeScoringSystemPascaAnestesi(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join dokter on post_anesthesia_discharge_scoring_system.kd_dokter=dokter.kd_dokter "+
                    "inner join petugas on post_anesthesia_discharge_scoring_system.nip=petugas.nip where "+
                    "post_anesthesia_discharge_scoring_system.tanggal between ? and ? order by post_anesthesia_discharge_scoring_system.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,post_anesthesia_discharge_scoring_system.tanggal,"+
                    "post_anesthesia_discharge_scoring_system.penilaian_skala1,post_anesthesia_discharge_scoring_system.penilaian_nilai1,"+
                    ...
                    "inner join dokter on post_anesthesia_discharge_scoring_system.kd_dokter=dokter.kd_dokter "+
                    "inner join petugas on post_anesthesia_discharge_scoring_system.nip=petugas.nip where "+
                    "post_anesthesia_discharge_scoring_system.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? "+
                    "or post_anesthesia_discharge_scoring_system.kd_dokter like ? or dokter.nm_dokter like ? or post_anesthesia_discharge_scoring_system.nip like ? or petugas.nama like ?) "+
                    "order by post_anesthesia_discharge_scoring_system.tanggal ");
            }
    ...
    private void ganti() {
        if(Sequel.mengedittf("post_anesthesia_discharge_scoring_system","tanggal=? and no_rawat=?","no_rawat=?,tanggal=?,penilaian_skala1=?,penilaian_nilai1=?,"+
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from post_anesthesia_discharge_scoring_system where tanggal=? and no_rawat=?",2,new String[]{
    ...
    private void isTotalResiko(){
        try {
            ...
            if(Integer.parseInt(NilaiKriteriaTotal.getText())>=9){
                TingkatSkor.setText("Pasien Bisa Dipindahkan Ke Ruangan Perawatan Bila Skor Minimal 9");
            }else if(Integer.parseInt(NilaiKriteriaTotal.getText())<9){
                TingkatSkor.setText("Pasien Tidak Dapat Dipindahkan Ke Ruangan Perawatan, Karena Kondisi Yang Lemah");
            }
        } catch (Exception e) {
            NilaiKriteriaTotal.setText("0");
