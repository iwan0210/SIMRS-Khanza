...
public class DlgTemplateResep extends javax.swing.JDialog {
    ...
    public DlgTemplateResep(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.Resep","Tgl.Resep","Jam Resep","No.Rawat","No.RM","Pasien","Dokter Peresep","Kode Dokter","Status","Nama Template"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Template Resep ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        NmTemplate.setPreferredSize(new java.awt.Dimension(180, 24));
        NmTemplate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NmTemplateActionPerformed(evt);
            }
        });
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Data Template Resep ]::");
    ...
    private void BtnKeluarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKeluarKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){            
            dispose();              
        }else{Valid.pindah(evt,BtnTambah,NmTemplate);}
...
*/
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(),0).toString().equals("")){
                ...
                Sequel.meghapus("template_resep","no_resep",tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(),0).toString()); 
                tampil();               
            }
        }
    ...
    private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            ...
            Valid.pindah(evt, NmTemplate,BtnHapus);
        }
    ...
    private void NmTemplateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NmTemplateActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NmTemplateActionPerformed
            ...
            try{
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("status"),rs.getString("nama_template")
                    });  
