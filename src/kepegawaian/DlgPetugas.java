        ...
        if(tabMode.getRowCount()==0){
            ...
            if(tbPetugas.getSelectedRow()> -1){
                ...
                Valid.MyReportqry("rptKartuPetugas.jasper","report","::[ Kartu Petugas ]::",
                    "select petugas.nip,petugas.nama,petugas.jk,petugas.tmp_lahir,petugas.tgl_lahir,concat('https://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/penggajian/',pegawai.photo) as photo, "+
                    "petugas.gol_darah,petugas.agama,petugas.stts_nikah,petugas.alamat,jabatan.nm_jbtn,petugas.no_telp "+
