...
public final class DlgIGD extends javax.swing.JDialog {
    ...
    public DlgIGD(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"P","No.Reg","No.Rawat","Tanggal","Jam","Kd.Dokter","Dokter Dituju","Nomer RM",
            ...
            "Biaya Regristrasi","Status","Jenis Bayar","Stts Rawat","Kd PJ","Status Bayar","Finger"};
    ...
    private void initComponents() {
        ...
        MnPenilaianAwalKeperawatanKebidananIGD.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPenilaianAwalKeperawatanKebidananIGD.setForeground(new java.awt.Color(50, 50, 50));
        MnPenilaianAwalKeperawatanKebidananIGD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPenilaianAwalKeperawatanKebidananIGD.setText("Penilaian Awal Keperawatan Kebidanan & Kandungan");
        MnPenilaianAwalKeperawatanKebidananIGD.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPenilaianAwalKeperawatanKebidananIGD.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPenilaianAwalKeperawatanKebidananIGD.setName("MnPenilaianAwalKeperawatanKebidananIGD"); // NOI18N
        MnPenilaianAwalKeperawatanKebidananIGD.setPreferredSize(new java.awt.Dimension(310, 26));
        MnPenilaianAwalKeperawatanKebidananIGD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        MnPenilaianPreOp.setText("Asesmen Pra Operasi");
        ...
        BtnUpdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/user.png"))); // NOI18N
        BtnUpdate.setMnemonic('U');
        BtnUpdate.setText("Finger");
       ...
       if(TNoReg.getText().trim().equals("")){
            ...
            if(ceksukses==true){
                ...
                tabMode.addRow(new Object[] {
                    ...
                    TStatus.getText(),nmpnj.getText(),"Belum",kdpnj.getText(),"Belum Bayar","Belum"
                });
    ...
    private void BtnHapusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnHapusKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt, BtnBatal, BtnUpdate);
        }
    ...
    private void BtnUpdateActionPerformed(java.awt.event.ActionEvent evt) {
	    ...
	    requestEntity = new HttpEntity(headers);
            URL = link+"/SEP/FingerPrint/List/Peserta/TglPelayanan/"+LocalDate.now().toString();	
            ...
            if(nameNode.path("code").asText().equals("200")){
                ...
                if(response.isArray()){
                    Sequel.meghapustf("bpjs_finger", "tanggal", LocalDate.now().toString());
                    i=1;
                    for(JsonNode list:response){
                        if (!Sequel.menyimpantf2("bpjs_finger", "?,?,?", 3, new String[] {
                            LocalDate.now().toString(),
                            list.path("noKartu").asText(),list.path("noSEP").asText()
                        })) {
...
private void MnLaporanRekapKunjunganBulananPoliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanRekapKunjunganBulananPoliActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnPenilaianAwalKeperawatanKebidananIGD;
    ...
    private javax.swing.JMenuItem MnPenilaianPreInduksi,MnHasilPemeriksaanEKG,MnSudahTerbitSEP,MnPenilaianPasienImunitasRendah,MnCatatanKeseimbanganCairan,MnCatatanObservasiCHBP,MnCatatanObservasiInduksiPersalinan,
                                  ...
                                  MnSkriningInstrumenACRS,MnPernyataanMemilihDPJP,MnSkriningInstrumenMentalEmosional,MnCheckListKriteriaMasukNICU,MnCheckListKriteriaMasukPICU,MnSkriningInstrumenAMT,MnSkriningPneumoniaSeverityIndex,MnHasilPemeriksaanTreadmill,MnHasilPemeriksaanECHOPediatrik,MnSkriningInstrumenESAT,MnSkriningCURB65;
                ...
                protected Void doInBackground() {
                    try{  
                        ps=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
							   ...
							   "IF(bpjs_finger.no_kartu IS NULL, 'Belum', 'Sudah') as status_finger " +
                               "from reg_periksa inner join dokter inner join pasien inner join poliklinik inner join penjab "+
                               "on reg_periksa.kd_dokter=dokter.kd_dokter and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                               "and reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.kd_poli=poliklinik.kd_poli "+
							   "left join bpjs_finger on bpjs_finger.no_kartu = pasien.no_peserta and bpjs_finger.tanggal = reg_periksa.tgl_registrasi where "+
                        ...
                        try {
                            ...
                            while(rs.next()){
                                Object[] row = new Object[]{
                                    ...
                                    rs.getString("kd_pj"),rs.getString("status_bayar"),rs.getString("status_finger")
                                };
                                i++;
                                publish(row);
                            }
    ...
    public void isCek(){
        ...
        BtnUpdate.setEnabled(akses.getigd());
        ...
        MnPenilaianAwalKeperawatanKebidananIGD.setEnabled(akses.getpenilaian_awal_keperawatan_kebidanan());
