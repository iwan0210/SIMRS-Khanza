            ...
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                try {
                    rs2=koneksi.prepareStatement(
                        ...
                        "laporan_operasi.laporan_operasi,laporan_operasi.sifat_tindakan,laporan_operasi.penyulit,laporan_operasi.kehilangan_darah,laporan_operasi.komplikasi,laporan_operasi.macam_operasi,laporan_operasi.nomor_implan "+
